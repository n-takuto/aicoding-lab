...
## ステップ 1：Git for Windows をインストール（推奨）

Claude Code は単体でも動きますが、**Git for Windows** を入れておくと Bash 経由のコマンド実行ができるようになり、できることが増えます。**強く推奨** です。
...
ネットで検索すると古い情報として、こんなコマンドが出てきます：

```
npm install -g @anthropic-ai/claude-code
```

これは **2026年初頭から段階的に廃止予定** の旧方式です。今は使わない方が無難。**ネイティブインストーラー（このページのステップ2）を使ってください**。
...
次回は、**Claude Code を入れたあと最初に試したい便利コマンド5選** を紹介する予定です。お楽しみに！
